    ...
    async processIncomingMessage(context){
        ...
        if(!conversationReference){
            ...
            if(parsedValues.length>0){
                ...
                await context.sendActivity('Invalid format. Should end with either of below format<br><b>in</b> \'x\' minutes|hours<br><i>  e.g Remind to update timesheet in 30 minutes | 2 hours</i><br><b>at</b> "HH:MM" or "H" <br><i>  e.g Remind To update status at 3:05pm | 3pm | 15</i>');
            }
